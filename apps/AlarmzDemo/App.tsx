/**
 * AlarmzDemo - Daily Alarm Scheduler
 */
      ...
      >
        <View style={{ flex: 1, padding: 20 }}>
          ...
          <View style={{ marginTop: 60, marginBottom: 40 }}>
            <Text style={{ fontSize: 32, fontWeight: 'bold', color: '#00FF00', textAlign: 'center' }}>
              AlarmzDemo
            </Text>
            <Text style={{ fontSize: 16, color: '#808080', textAlign: 'center', marginTop: 8 }}>
              Schedule Your Daily Alarm
            </Text>
          </View>

          {/* Permission Section */}
          <View style={{ backgroundColor: '#1a1a1a', borderRadius: 12, padding: 20, marginBottom: 20 }}>
            <Text style={{ fontSize: 18, color: '#FFFFFF', marginBottom: 12 }}>
              Step 1: Grant Permission
            </Text>
            <TouchableOpacity
              onPress={requestPermission}
              style={{
                backgroundColor: hasPermission ? '#00FF00' : '#FFA500',
                padding: 16,
                borderRadius: 8,
                alignItems: 'center',
              }}
          ...
          {/* Info Section */}
          <View style={{ marginTop: 40, padding: 20, backgroundColor: '#1a1a1a', borderRadius: 12 }}>
            ...
            <Text style={{ color: '#808080', fontSize: 12, marginTop: 8, lineHeight: 18 }}>
              Scheduled alarms will appear above.{'\n'}
